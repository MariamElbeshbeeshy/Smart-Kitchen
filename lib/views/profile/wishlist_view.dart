...
class WishListView extends StatelessWidget {
  ...
  static const String id = 'wishlist_view';
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      "Explore our marketplace and tap the heart icon to add recipes to your WishList!",
              ...
              return MarketplaceCard(
                ...
                onAddToCart: () {
                  ...
                  showCartNotification(context, product.name, onViewPressed: () {
                    ...
                    NavigationView.changeTab(1); // Cart is now index 1
                  });
                },
              );
            },
